  ...
  return <div>
    ...
    <div className="menu-layout">
      <section className="panel-card editor-card">
        ...
        <div className="panel-field"><label>Imagen <span>Opcional</span></label><label className="upload"><input type="file" accept="image/*" onChange={(e) => setImagenFile(e.target.files?.[0] || null)} /><b>{imagenFile ? imagenFile.name : 'Seleccionar imagen'}</b><small>JPG, PNG o WebP</small></label></div>
